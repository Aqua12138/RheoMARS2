...
class CriticDataset:
    def __init__(self, batch_size, obs, target_values, shuffle = False, drop_last = False):
        self.obs = {"gridsensor3d": obs["gridsensor3d"].view(-1, obs["gridsensor3d"].shape[2], obs["gridsensor3d"].shape[3], obs["gridsensor3d"].shape[4]),
    ...
    def shuffle(self):
        ...
        self.obs = {"gridsensor3d": self.obs["gridsensor3d"][index, :], "vector_obs": self.obs["vector_obs"][index, :]}
    ...
    def __getitem__(self, index):
        ...
        tmp_obs = {"gridsensor3d": self.obs["gridsensor3d"][start_idx:end_idx, :], "vector_obs": self.obs["vector_obs"][start_idx:end_idx, :]}

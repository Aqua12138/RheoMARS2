...
ti.init(arch=ti.gpu, device_memory_GB=14, packed=True)
...
class TaichiEnv:
    ...
    def get_state(self):
        return {
            ...
            't': self.t,
            'f_global': self.simulator.cur_substep_global
        }

    def set_state(self, state, grad_enabled=False, t=0, f_global=0):
        self.t = t

        self.simulator.cur_substep_global = f_global
        self.simulator.set_state(f_global, state)

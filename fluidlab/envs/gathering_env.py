...
class GatheringEnv(FluidEnv):
    def __init__(self, loss=True, loss_cfg='diff', seed=None, renderer_type='GGUI', perc_type="physics"):
        super(GatheringEnv).__init__(loss, loss_cfg, seed, renderer_type, perc_type)

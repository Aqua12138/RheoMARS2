...
class TrainablePolicy:
    def __init__(self, optim_cfg, init_range, action_dim, horizon, action_range, fix_dim=None):
        ...
        self.actions_v = np.random.uniform(ast.literal_eval(init_range.v)[0], ast.literal_eval(init_range.v)[0], size=(horizon, action_dim))
        self.actions_p = np.random.uniform(ast.literal_eval(init_range.p)[0], ast.literal_eval(init_range.p)[1], size=(action_dim))
